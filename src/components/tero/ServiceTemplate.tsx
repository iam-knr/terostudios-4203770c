  ...
  return (
    <PageLayout>
      ...
      <section className="container-tero py-24 md:py-32">
        ...
        <div className="mt-10">
          <Link to="/work" className="group inline-flex items-center gap-3 font-mono text-[12px] uppercase tracking-[0.2em] text-ink">
            View full portfolio
      ...
      {/* ── TESTIMONIAL ──────────────────────────────────────── */}
      <section className="border-y border-parchment bg-ink text-cream">
        <div className="container-tero py-20 md:py-28">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-12 md:items-center">
            <div className="md:col-span-4">
              <p className="overline text-vermillion">— Client testimonial</p>
              <div className="mt-6 flex h-28 w-28 items-center justify-center rounded-full border border-cream/15 bg-cream/5 font-sans-display text-[24px] font-bold">
                ★ ★ ★ ★ ★
              </div>
              <p className="mt-5 font-sans-display text-[16px] font-bold text-cream">A partner brand</p>
              <p className="mt-1 font-mono text-[11px] uppercase tracking-[0.2em] text-cream/50">Marketing lead</p>
            </div>
            <div className="md:col-span-8">
              <p className="font-sans-display text-[clamp(22px,2.6vw,34px)] leading-[1.3] text-cream">
                “Tero delivered our {service.name.toLowerCase()} on a tight window without dropping a beat. The work came back sharper than the brief — and the team made it look effortless.”
              </p>
            </div>
          </div>
        </div>
