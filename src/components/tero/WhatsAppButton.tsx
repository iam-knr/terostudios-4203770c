...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="fixed bottom-24 right-8 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_30px_rgba(37,211,102,0.45)] transition-transform duration-300 hover:scale-110"
    >
