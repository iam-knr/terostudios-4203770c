...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="group fixed bottom-24 right-8 z-50 flex h-12 w-12 items-center justify-center rounded-full border border-parchment/30 bg-ink/50 text-cream backdrop-blur-md shadow-[0_8px_30px_rgba(0,0,0,0.18)] transition-all duration-300 hover:bg-vermillion hover:border-vermillion/40 hover:shadow-[0_8px_30px_rgba(232,57,14,0.35)]"
    >
