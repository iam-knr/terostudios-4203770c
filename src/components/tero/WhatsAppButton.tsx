...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="group fixed bottom-24 right-8 z-50 flex h-12 w-12 items-center justify-center rounded-full border border-cream/25 bg-transparent text-cream/80 backdrop-blur-sm transition-all duration-300 hover:border-cream/50 hover:text-cream hover:bg-cream/5"
    >
