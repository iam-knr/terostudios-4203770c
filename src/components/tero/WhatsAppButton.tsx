...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="group fixed bottom-24 right-8 z-50 flex h-12 w-12 items-center justify-center rounded-full border border-current bg-transparent text-white mix-blend-difference backdrop-blur-sm transition-opacity duration-300 opacity-70 hover:opacity-100"
    >
