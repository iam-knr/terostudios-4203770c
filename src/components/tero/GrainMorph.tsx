...
const ICONS: string[] = [
  ...
  // 4 — Event & Immersive Hardware: stage with big LED screen and speakers
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="3" width="16" height="11" rx="1"/><path d="M6 6h12M6 9h12M6 12h12"/><path d="M2 17h20l-1 4H3z"/><rect x="3.5" y="15.5" width="2.5" height="2"/><rect x="18" y="15.5" width="2.5" height="2"/></svg>`,
